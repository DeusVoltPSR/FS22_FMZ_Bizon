...
function AddConfig:getXMLPrefix(configName)
	...
	if configName == "motor" or configName == "consumer" or configName == "differential" then
		prefix = "motorized.";
	elseif configName == "wheel" or configName == "ackermannSteering" or configName == "hub" then
		prefix =  "wheels.";
	...
	elseif configName == "inputAttacherJoint" then
		prefix = "attachable.";
	elseif configName == "powerTakeOff" then
		prefix = "powerTakeOffs.";
	elseif configName == "design2" then
		prefix = "design2";
	elseif configName == "design3" then
		prefix = "design3";
	elseif configName == "design4" then
		prefix = "design4"
	elseif configName == "design5" then
		prefix = "design5";
	elseif configName == "design6" then
		prefix = "design6";
	elseif configName == "design7" then
		prefix = "design7";
	elseif configName == "design8" then
		prefix = "design8";
	end;
...
function AddConfig:getConfigKey(configName, configId, secondConfigName)
	...
	if not hasXMLProperty(self.xmlFile, configKey) then
        printError("(getCofingKey) :: Invalid " .. configName .. " configuration " .. configId .. " (key = " .. configKey .. ")", true, false);
